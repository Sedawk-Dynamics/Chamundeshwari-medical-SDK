...
export const equipmentCatalogue: EquipmentCard[] = [
  ...
  /* ── Ambulance Setup ───────────────────────────────────────────────────────── */
  {
    ...
    highlights: [
      ...
      'Onboard oxygen & suction setup',
      'Stretcher & spine board systems',
    ],
    catalogueSlug: 'ambulance',
    inNav: false,
  },
  {
    ...
    badges: ['Sale', 'Rental'],
    desc: 'T-piece neonatal resuscitator designed to deliver controlled, precise PIP and PEEP pressure during emergency infant transport and resuscitation.',
    highlights: [
      'Precise Peak Inspiratory Pressure (PIP)',
      'Built-in PEEP safety valve',
      'Lightweight and portable for transport',
    ],
    catalogueSlug: 'infant-resuscitator',
    inNav: false,
  },
  {
    ...
    badges: ['Sale', 'Rental'],
    desc: 'Compact and portable ventilator delivering comprehensive critical care ventilation for pediatric and adult patients during mobile emergency transport.',
    highlights: [
      'Pressure & volume control modes',
      'Internal turbine (no compressed air needed)',
      'Compact design for ambulance mounting',
    ],
    catalogueSlug: 'ltv-950-transport-ventilator',
    inNav: false,
  },
  {
    slug: 'defibrillator',
    ...
    badges: ['Sale', 'Rental'],
    desc: 'Portable cardiac defibrillator and multiparameter monitor featuring manual biphasic shock, AED mode, and ECG monitoring for mobile care.',
    highlights: [
      'Biphasic manual & AED shock delivery',
      'Integrated ECG waveform display',
      'Fast charge time with battery backup',
    ],
    catalogueSlug: 'defibrillator',
    inNav: false,
  },
  ...
  /* ── Home ICU Setup ───────────────────────────────────────────────────────── */
  {
    ...
    highlights: [
      ...
      'Oxygen concentrators and oxygen cylinders, BiPAP & hospital beds',
